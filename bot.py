...
# Токены для работы
TG_BOT_TOKEN = os.getenv("TG_BOT_TOKEN")  # Получение токена Telegram из окружения
CMC_API_KEY = os.getenv("CMC_API_KEY")    # Получение API-ключа CoinMarketCap из окружения
